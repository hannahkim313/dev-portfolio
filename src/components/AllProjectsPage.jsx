  ...
  <main className={styles.main}>
    ...
    <section className={styles.projectsContainer}>
      <article className={styles.projectCard}>
        <Link to="/projects/blog-api" state={blogApiState}>
      ...
      <article className={styles.projectCard}>
        ...
        <div className={styles.projectDetails}>
          <Link
            ...
            state={inventoryMateState}
          >
            <h2>InventoryMate: Inventory Management Application</h2>
          </Link>
          <p>
            An inventory management application built with Express and MongoDB,
            featuring site-specific routes, EJS templates for dynamic views, and
            an MVC architecture. This project enables users to create, read,
            update, and delete (CRUD) categories and items within a structured
            interface.
          </p>
        </div>
      </article>
      <article className={styles.projectCard}>
        <Link to="/projects/mock-e-commerce-store" state={urbanThreadState}>
          <div className={styles.projectThumbnailContainer}>
            <img
              className={styles.projectThumbnail}
              src={urbanThreadImgSrc}
      ...
      <article className={styles.projectCard}>
        <Link to="/projects/memory-card-game" state={memoryCardGameState}>
          <div className={styles.projectThumbnailContainer}>
            <img
              className={styles.projectThumbnail}
              src={memoryCardImgSrc}
        ...
        <div className={styles.projectDetails}>
          ...
          <p>
            ...
            players' memory and recall abilities. This project utilizes hooks
            for managing state and side effects while fetching card data from
            the Nintendo Amiibo API, creating a smooth user experience as
            players attempt to match pairs of cards.
          </p>
        </div>
      </article>
      <article className={styles.projectCard}>
        <Link to="/projects/battleship" state={battleshipState}>
          <div className={styles.projectThumbnailContainer}>
            <img
              className={styles.projectThumbnail}
              src={battleshipImgSrc}
